  ...
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]}>
        <mesh    geometry={nodes.Object_2.geometry} material={materials.Car_Paint} />
        <mesh   geometry={nodes.Object_3.geometry} material={materials['Car_Paint.001']} />
        ...
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_13.geometry} material={materials.Red_car_lights_glass} />
        <mesh material-color={sanp.items.color}  geometry={nodes.Object_14.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_15.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_16.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_17.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_18.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_19.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_20.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_21.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_22.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_23.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_24.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_25.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_26.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh  material-color={sanp.items.color} geometry={nodes.Object_27.geometry} material={materials.Car_Paint_With_Flakes} />
        <mesh   geometry={nodes.Object_28.geometry} material={materials.Car_chrome} />
        <mesh   geometry={nodes.Object_29.geometry} material={materials.Car_chrome} />
        <mesh   geometry={nodes.Object_30.geometry} material={materials.Car_chrome} />
        <mesh   geometry={nodes.Object_31.geometry} material={materials.Car_chrome} />
        <mesh   geometry={nodes.Object_32.geometry} material={materials.Car_chrome} />
        <mesh   geometry={nodes.Object_33.geometry} material={materials.Car_chrome} />
        <mesh   geometry={nodes.Object_34.geometry} material={materials.Car_chrome} />
